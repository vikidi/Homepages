...
const Autosave =
    () => {
      ...
      return (
          ...
          <CheckCircleOutlineIcon className = {classes.root} htmlColor = {
...
const SettingsView = () => {
  ...
  const handleThemeChange =
      event => { d(setTheme(getThemeByName(event.target.value))) }
  ...
  return (
      <ViewWrapper header footer fullMain><GridContainer><Grid item md = {9}>
      <BackgroundPaper><GridContainer direction = 'column' vertical = 'stretch'>

      <Typography variant = "h3" gutterBottom>{t('SettingsView.title')}<
          /Typography>
